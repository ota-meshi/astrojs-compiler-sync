...
/** @type {Set<()=>boolean>} */
const terminateRemainingProcesses = new Set();
...
function terminateWorker() {
  ...
  terminateRemainingProcesses.add(tryTerminate);
  for (const fn of [...terminateRemainingProcesses]) {
    if (fn()) {
      terminateRemainingProcesses.delete(fn);
    }
  }
